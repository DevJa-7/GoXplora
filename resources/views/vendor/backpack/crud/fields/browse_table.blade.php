...
<div ng-app="backPackTableApp" ng-controller="tableControllerDouble" @include('crud::inc.field_wrapper_attributes') >
    ...
    <div class="array-container form-group">
            ...
            <thead>
                <tr>
                    @foreach ( $field['columns'] as $column)
                        ...
                        <th style="width: 30px" class="text-center" ng-if="max == -1 || max > 1"> {{-- <i class="nav-icon la la-cloud-upload"></i> --}} </th>
                        @endif
                    @endforeach
                    <th style="width: 30px" class="text-center" ng-if="max == -1 || max > 1"> {{-- <i class="nav-icon la la-sort"></i> --}} </th>
                    <th style="width: 30px" class="text-center" ng-if="max == -1 || max > 1"> {{-- <i class="nav-icon la la-trash"></i> --}} </th>
                </tr>
            </thead>
                ...
                <tr ng-repeat="item in items" class="array-row">
                        ...
                        @if($column['type'] == 'browse')
                            ...
                            <td>
                                ...
                                <i class="nav-icon la la-cloud-upload"></i></button>
                            </td>
                        @endif
                    ...
                    <td ng-if="max == -1 || max > 1">
                        ...
                        <i class="nav-icon la la-sort" role="presentation" aria-hidden="true"></i></span>
                    </td>
                    <td ng-if="max == -1 || max > 1">
                        ...
                        <i class="nav-icon la la-trash" role="presentation" aria-hidden="true"></i></button>
                    </td>
        ...
        <div class="array-controls btn-group m-t-10">
            <button ng-if="max == -1 || items.length < max" class="btn btn-sm btn-default" type="button" ng-click="addItem()"><i class="nav-icon la la-plus"></i> {{trans('backpack::crud.add')}} {{ $item_name }}</button>
        </div>
